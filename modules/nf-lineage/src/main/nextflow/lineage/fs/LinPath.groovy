...
class LinPath implements Path, LogicalDataPath {
     ...
     * @param asMetadataPath True to return metadata descriptions as LinMetadataPath
     * @param subPath Sub-path of a FileOutput (used internally)
     ...
     */
    protected static Path findTarget(LinFileSystem fs, String filePath, boolean asMetadataPath, String subPath=null) throws Exception {
        if( !fs )
    ...
    protected Path getTargetPath() {
        return findTarget(fileSystem, filePath, false)
    }
    ...
    protected Path getTargetOrMetadataPath() {
        return findTarget(fileSystem, filePath, true)
    }
